...
async def marine_scottish_water_overflows_context() -> dict[str, Any]:
    return {
        ...
        "sourceHealth": {
            ...
            "detail": "Fixture Scottish Water overflow context.",
            "errorSummary": None,
            "caveat": "Fixture/local mode. Overflow monitor activation is source-reported infrastructure context only and does not confirm pollution impact or vessel behavior.",
        },
        "events": [
            {
