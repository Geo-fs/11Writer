...
export const AEROSPACE_EXPORT_PROFILES: AerospaceExportProfileDefinition[] = [
  {
    ...
    includedMetadataKeys: ["selectedTargetSummary", "aerospaceDataHealth", "aerospaceOperationalContext", "aerospaceExportReadiness", "aerospaceCurrentArchiveContext", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["selected-target", "context-report", "data-health", "readiness", "snapshot-report-package", "export-coherence", "issue-export-bundle", "current-archive-space-weather", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "operational-context", "availability"],
  ...
  },
  {
    ...
    includedMetadataKeys: ["aerospaceOperationalContext", "aerospaceContextAvailability", "aerospaceDataHealth", "aerospaceExportReadiness", "nceiSpaceWeatherArchiveContext", "aerospaceCurrentArchiveContext", "aerospaceSourceReadiness", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["context-report", "operational-context", "readiness", "snapshot-report-package", "export-coherence", "issue-export-bundle", "current-archive-space-weather", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "availability", "selected-target", "data-health", "airport-weather", "space-context", "space-weather-archive", "focus-history"],
  ...
  },
  {
    ...
    includedMetadataKeys: ["aviationWeatherContext", "faaNasAirportStatus", "aerospaceOperationalContext", "aerospaceExportReadiness", "aerospaceCurrentArchiveContext", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["context-report", "airport-weather", "readiness", "snapshot-report-package", "issue-export-bundle", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "selected-target", "data-health", "operational-context", "availability"],
  ...
  },
  {
    ...
    includedMetadataKeys: ["cneosSpaceContext", "swpcSpaceWeatherContext", "nceiSpaceWeatherArchiveContext", "aerospaceCurrentArchiveContext", "vaacContext", "aerospaceOperationalContext", "aerospaceExportReadiness", "aerospaceSourceReadiness", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["context-report", "space-context", "snapshot-report-package", "export-coherence", "issue-export-bundle", "current-archive-space-weather", "space-weather-archive", "geomagnetism-context", "readiness", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "selected-target", "data-health", "operational-context", "availability"],
  ...
  },
  {
    ...
    includedMetadataKeys: ["aerospaceDataHealth", "aerospaceContextAvailability", "aerospaceOperationalContext", "aerospaceExportReadiness", "aerospaceCurrentArchiveContext", "aerospaceSourceReadiness", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["context-report", "data-health", "readiness", "snapshot-report-package", "export-coherence", "issue-export-bundle", "current-archive-space-weather", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "availability", "selected-target", "operational-context"],
  ...
  },
  {
    ...
    includedMetadataKeys: ["aerospaceFocus", "aerospaceFocusHistory", "selectedTargetSummary", "aerospaceDataHealth", "aerospaceExportReadiness", "aerospaceCurrentArchiveContext", "aerospaceSourceReadinessBundle", "aerospaceContextGapQueue", "aerospaceExportCoherence", "aerospaceIssueExportBundle", "aerospaceContextSnapshotReport"],
    preferredFooterSections: ["context-report", "focus-history", "selected-target", "data-health", "readiness", "snapshot-report-package", "issue-export-bundle", "context-gap-queue", "source-readiness-bundle", "source-readiness", "review-queue", "issue-summary", "operational-context", "availability"],
